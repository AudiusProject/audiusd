...
#####################################################################
###                   Audiusd Config Options                      ###
#####################################################################
[audiusd]

# Endpoint that this node will be reachable at, MUST match the endpoint registered
# on ethereum for validators.
endpoint = "{{ .Audiusd.Endpoint }}"

###############################################################################
###                 Audiusd Advanced Configuration Options                  ###
###############################################################################
...
# Make the {endpoint}/console* routes accessible, must also have the etl enabled
enabled = {{ .Audiusd.Console.Enabled }}

log_level = "{{ .Audiusd.Console.LogLevel }}"
