...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/AudiusProject/audiusd/pkg/gen/core/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	CoreServiceHealthCheckProcedure = "/core.v1.CoreService/HealthCheck"
...
func NewCoreServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CoreServiceClient {
	...
	coreServiceMethods := v1.File_core_v1_rpc_proto.Services().ByName("CoreService").Methods()
...
// HealthCheck calls core.v1.CoreService.HealthCheck.
func (c *coreServiceClient) HealthCheck(ctx context.Context, req *connect.Request[v1.HealthCheckRequest]) (*connect.Response[v1.HealthCheckResponse], error) {
...
func (UnimplementedCoreServiceHandler) HealthCheck(context.Context, *connect.Request[v1.HealthCheckRequest]) (*connect.Response[v1.HealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("core.v1.CoreService.HealthCheck is not implemented"))
}
