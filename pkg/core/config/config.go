...
func ReadConfig(logger *common.Logger) (*Config, error) {
	...
	var cfg Config
	// comet config
	cfg.LogLevel = GetEnvWithDefault("audius_core_log_level", "p2p:none,mempool:none,rpc:none,state:info,*:error")
	...
	cfg.RetainHeight = int64(getEnvIntWithDefault("retainHeight", 128))
