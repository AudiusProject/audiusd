...
type V1ReleaseHeader struct {
	...
	// recipient
	Recipient *V1MessagingParty `json:"recipient,omitempty"`

	// sender
	Sender *V1MessagingParty `json:"sender,omitempty"`

	// sent on behalf of
	SentOnBehalfOf *V1MessagingParty `json:"sentOnBehalfOf,omitempty"`
}
