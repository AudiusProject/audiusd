-- Migration 0015 Down: Revert validator uptime summary fix

-- Drop the updated view
DROP VIEW IF EXISTS v_validator_uptime_summary;

-- Restore the original view from migration 0012 (though it won't work without the regular views)
-- This is mainly for consistency - the original view would still be broken until migration 0014 is reverted
