...
type PieMessage_Party struct {
	...
	Enrichment     []*PieMessage_Enrichment    `protobuf:"bytes,5,rep,name=enrichment,proto3" json:"enrichment,omitempty"`
}
...
func (x *PieMessage_Party) GetEnrichment() []*PieMessage_Enrichment {
	if x != nil {
		return x.Enrichment
	}
	return nil
...
type PieMessage_Enrichment struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*PieMessage_Enrichment_Handle
	//	*PieMessage_Enrichment_Verified
	Enrichment isPieMessage_Enrichment_Enrichment `protobuf_oneof:"enrichment"`
}

func (x *PieMessage_Enrichment) Reset() {
	*x = PieMessage_Enrichment{}
	if protoimpl.UnsafeEnabled {
...
func (x *PieMessage_Enrichment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PieMessage_Enrichment) ProtoMessage() {}

func (x *PieMessage_Enrichment) ProtoReflect() protoreflect.Message {
	mi := &file_ddex_v1beta1_pie_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PieMessage_Enrichment.ProtoReflect.Descriptor instead.
func (*PieMessage_Enrichment) Descriptor() ([]byte, []int) {
	return file_ddex_v1beta1_pie_proto_rawDescGZIP(), []int{0, 2}
}

func (m *PieMessage_Enrichment) GetEnrichment() isPieMessage_Enrichment_Enrichment {
	if m != nil {
		return m.Enrichment
	}
	return nil
...
func (x *PieMessage_Enrichment) GetHandle() *PieMessage_Handle {
	if x, ok := x.GetEnrichment().(*PieMessage_Enrichment_Handle); ok {
		return x.Handle
	}
	return nil
}

func (x *PieMessage_Enrichment) GetVerified() *PieMessage_Verified {
	if x, ok := x.GetEnrichment().(*PieMessage_Enrichment_Verified); ok {
		return x.Verified
	}
	return nil
}

type isPieMessage_Enrichment_Enrichment interface {
	isPieMessage_Enrichment_Enrichment()
}

type PieMessage_Enrichment_Handle struct {
	Handle *PieMessage_Handle `protobuf:"bytes,1,opt,name=handle,proto3,oneof"`
}

type PieMessage_Enrichment_Verified struct {
	Verified *PieMessage_Verified `protobuf:"bytes,2,opt,name=verified,proto3,oneof"`
}

func (*PieMessage_Enrichment_Handle) isPieMessage_Enrichment_Enrichment() {}

func (*PieMessage_Enrichment_Verified) isPieMessage_Enrichment_Enrichment() {}
...
var file_ddex_v1beta1_pie_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x72, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb9, 0x06, 0x0a, 0x0a,
	...
	0x61, 0x72, 0x74, 0x79, 0x1a, 0xd7, 0x02, 0x0a, 0x05, 0x50, 0x61, 0x72, 0x74, 0x79, 0x12, 0x27,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x3a, 0x0a, 0x08, 0x56,
	0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x76,
	0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x76,
	0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_ddex_v1beta1_pie_proto_goTypes = []interface{}{
	...
	(*PieMessage_Enrichment)(nil),      // 3: ddex.v1beta1.PieMessage.Enrichment
...
var file_ddex_v1beta1_pie_proto_depIdxs = []int32{
	...
	3, // 6: ddex.v1beta1.PieMessage.Party.enrichment:type_name -> ddex.v1beta1.PieMessage.Enrichment
	4, // 7: ddex.v1beta1.PieMessage.Enrichment.handle:type_name -> ddex.v1beta1.PieMessage.Handle
	5, // 8: ddex.v1beta1.PieMessage.Enrichment.verified:type_name -> ddex.v1beta1.PieMessage.Verified
...
func file_ddex_v1beta1_pie_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ddex_v1beta1_pie_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PieMessage_Enrichment); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_ddex_v1beta1_pie_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*PieMessage_Enrichment_Handle)(nil),
		(*PieMessage_Enrichment_Verified)(nil),
	}
	type x struct{}
